...
public class Pc {
    ...
    public MemoryImageSource[] source = new MemoryImageSource[2];
    public MemoryImageSource currentSource;
    ...
    public void ggeti(int x, int y, short[] p, int w, int h) {
        int src = 0;
    ...
    public int ggetpix(int x, int y) {
    ...
    public void ginten(int inten) {
        currentSource = source[inten & 1];
        currentImage = image[inten & 1];
        currentSource.newPixels();
    }

    public void gpal(int pal) {
    }

    public void gputi(int x, int y, short[] p, int w, int h) {
        gputi(x, y, p, w, h, true);
    }

    public void gputi(int x, int y, short[] p, int w, int h, boolean b) {
        int src = 0;
        int dest = y * width + (x & 0xfffc);
    ...
    public void gputim(int x, int y, int ch, int w, int h) {
    ...
    public void gwrite(int x, int y, int ch, int c) {
        gwrite(x, y, ch, c, false);
    }

    public void gwrite(int x, int y, int ch, int c, boolean upd) {
