...
public class TeamService {
    ...
    public static void GameLoop_Team() {
        ...
        while (true) {
            ...
            House h = House_Get_ByIndex(t.houseID);
     ...
     */
    public static int Team_ActionStringToType(String name) {
        if (name == null) return TEAM_ACTION_INVALID;

        for (int type = 0; type < TEAM_ACTION_MAX; type++) {
