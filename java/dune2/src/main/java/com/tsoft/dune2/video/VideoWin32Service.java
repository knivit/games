...
public class VideoWin32Service {
    ...
    static String s_className = "OpenDUNE";
    static boolean s_init = false;
    static boolean s_lock = false;
    ...
    static int s_window_x_offset = 0;
    static int s_window_y_offset = 0;

    static String s_classNamePal = "OpenDUNEPal";
    ...
    static int s_screenOffset = 0;

    static boolean s_mouseTracking = false;

    static int s_mousePosX = 0;
    static int s_mousePosY = 0;
    static boolean s_mouseButtonLeft  = false;
    static boolean s_mouseButtonRight = false;

    static int s_mouseMinX = 0;
    static int s_mouseMaxX = 0;
    static int s_mouseMinY = 0;
    static int s_mouseMaxY = 0;

    static boolean s_showFPS = false;
    static boolean s_clearWindowBackground = false;

    class VkMapping {
        char  vk;
        int scan;

        public VkMapping(char vk, int scan) {
            this.vk = vk;
            this.scan = scan;
        }
    }

    static VkMapping M(char vk, int scan) { return new VkMapping(vk, scan); }

    static VkMapping[] s_keyMap = new VkMapping[] {
        M(VK_ESCAPE,     0x0001),
        M('1',           0x0002),
        M('2',           0x0003),
        M('3',           0x0004),
    ...
    static int MapKey(VkMapping vk) {
        int i;
    ...
    static LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
        ...
        switch (uMsg) {
            ...
            case WM_MOVE:
                s_x = (int)(LOWORD(lParam));
                s_y = (int)(HIWORD(lParam));
                return 0;
            ...
            case WM_SIZE: {
                s_window_width = (int)(LOWORD(lParam));
                s_window_height = (int)(HIWORD(lParam));
                return 0;
            }
    ...
    //#ifdef VIDEO_STATS
    static void Video_Stats(byte[] screen) {
        int i, j;
        static int[] freq = new int[256];
        int unused_colors;
        static int last_unused_colors = 0;
        int[] rgb12pal = new int[256];
        byte[] similar_color = new byte[256];
        int n_similar_colors;
        static int last_n_similar_colors = 0;
    ...
    public static void Video_SetPalette(byte[] palette, int from, int length) {
        byte[] p = palette;
        int i;
    ...
    public static void Video_Mouse_SetRegion(int minX, int maxX, int minY, int maxY) {
    ...
    public static byte[] Video_GetFrameBuffer(int size) {
        return s_screen;
    }
}
